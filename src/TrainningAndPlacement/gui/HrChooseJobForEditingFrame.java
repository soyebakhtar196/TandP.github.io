...
public class HrChooseJobForEditingFrame extends javax.swing.JFrame {
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                ...
                                .addGap(271, 271, 271)
                                .addComponent(btnEditJob, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnEditJobActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditJobActionPerformed
        ...
        job.setJobId(tblShowAllJobs.getValueAt(row,0).toString().trim());
        job.setJobTitle(tblShowAllJobs.getValueAt(row, 1).toString().trim());
        job.setTags(tblShowAllJobs.getValueAt(row, 2).toString().trim());
        job.setStatus(0);
